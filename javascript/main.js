...
const SliderMain = new Slider(
  document.querySelector("#main .Arrows"),
  document.querySelector("#main .items"),
  document.querySelector("#main .progress")
);

const SliderMain1 = new Slider(
  document.querySelector("#OeuvreMajeur .Arrows"),
  document.querySelector("#OeuvreMajeur .items"),
  null
);

const SliderMain2 = new Slider(
  document.querySelector("#calendrier .OeuvreArrow"),
  document.querySelector("#calendrier .items"),
  null
);

const SliderMain3 = new Slider(
  document.querySelector("#ventreRec .OeuvreArrow"),
